                        ...
                        for num_lstm_layer in num_lstm_layers:
                            for layer_hidden in layer_hiddens:
                                for roi in rois:
                                    ...
                                    tags = [roi, video_text, pooling_text, pooling_mode, lstm_text, freeze_text,
                                            str(layer_hidden)]
                                    ...
                                    cloned_task_parameters['Args/pooling_mode'] = 'spp'
...
start_tasks_adaptive_pooling(
    rois=['EBA', 'LOC', 'PPA', 'FFA', 'STS', 'PPA,FFA', 'FFA,PPA,STS'],
    video_sizes=[32, 48, 64, 96, 128],
    num_frames=[4],
    rfs=[8, 10, 12, 14, 16, 20, 24, 28, 32],
    freeze_bns=[False],
