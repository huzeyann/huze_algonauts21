...
for roi in rois:
    ...
    cloned_task.add_tags([roi, 'none', 'i3d_flow', 'x2,x3,x4', 'x2_spp', 'x3_no', 'x4_avg', '84'])
...
#                              parent=template_task.id)
#
#     cloned_task.add_tags([roi, 'none', 'i3d_flow', 'x2,x3,x4', 'x2_spp', 'x3_no', 'x4_avg'])
#
#     cloned_task_parameters = cloned_task.get_parameters()
#     # cloned_task_parameters['rois'] = [roi]
#     cloned_task_parameters['Args/rois'] = roi
...
#                              parent=template_task.id)
#
#     cloned_task.add_tags([roi, 'none', 'i3d_flow', 'x3', 'x3_no'])
#
#     cloned_task_parameters = cloned_task.get_parameters()
#     # cloned_task_parameters['rois'] = [roi]
#     cloned_task_parameters['Args/rois'] = roi
