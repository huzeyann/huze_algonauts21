...
def start_tasks_spp(rois, layers, ps, pts, freeze_bns, pooling_modes, pathways, pretrainings, batch_size=32, conv_size=256):
    for roi in rois:
        for layer in layers:
            for p in ps:
                for pt in pts:
                        ...
                        for pooling_mode in pooling_modes:
                            for pathway in pathways:
                                for pretraining in pretrainings:
                                    ...
                                    tags = [roi, layer, pooling_text, freeze_text, pathway, f'pretrained={pretraining}']
                                    ...
                                    cloned_task_parameters['Args/step_lr_epochs'] = [10] # 10
                                    ...
                                    cloned_task_parameters['Args/backbone_lr_ratio'] = 1.0 # 0.5
                                    cloned_task_parameters['Args/backbone_freeze_epochs'] = 100 # TODO 8
                                    ...
                                    cloned_task_parameters['Args/checkpoints_dir'] = '/mnt/huze/checkpoints_flow_ft/'
...
# backbone_freeze_epochs on separate run
